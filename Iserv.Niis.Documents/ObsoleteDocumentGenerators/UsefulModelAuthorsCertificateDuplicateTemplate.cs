...
{
    [DocumentGenerator(5163, "PAT_AVT_PM_D")]
    public class UsefulModelAuthorsCertificateDuplicateTemplate: DocumentGeneratorBase
    {
        public UsefulModelAuthorsCertificateDuplicateTemplate(IExecutor executor,
