...
{
    [TemplateFieldName(TemplateFieldName.ContractStorona2AddressKz)]
    internal class ContractStorona2AddressKz : TemplateFieldValueBase
    {
        public ContractStorona2AddressKz(IExecutor executor) : base(executor)
        {
