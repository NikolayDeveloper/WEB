...
{
    [DocumentGenerator(4197, "PO5_KZ")]
    public class Template579 : DocumentGeneratorBase
    {
        public Template579(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
