...
{
    [DocumentGenerator(6162, "OP_PAT_PM_KZ")]
    public class UsefulModelDescriptionKzTemplate: DocumentGeneratorBase
    {
        public UsefulModelDescriptionKzTemplate(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
