...
{
    [TemplateFieldName(TemplateFieldName.PatentAuthorsKz)]
    public class PatentAuthorsKz : TemplateFieldValueBase
    {
        public PatentAuthorsKz(IExecutor executor) : base(executor)
        {
        }
            ...
            switch (ownerType)
            {
                case Owner.Type.Request:
                    ...
                    authors = request.RequestCustomers
                        ...
                        .Select(customer => customer.Customer?.NameKz ?? string.Empty)
                        .ToArray();
