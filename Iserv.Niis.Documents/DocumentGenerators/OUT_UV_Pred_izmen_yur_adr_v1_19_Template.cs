...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.OUT_UV_Pred_izmen_yur_adr_v1_19)]
    public class OUT_UV_Pred_izmen_yur_adr_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pred_izmen_yur_adr_v1_19_Template(IExecutor executor,
