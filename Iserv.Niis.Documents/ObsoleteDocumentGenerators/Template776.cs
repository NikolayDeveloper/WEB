...
{
    [DocumentGenerator(10026, "SA_SOPR_1")]
    public class Template776 : DocumentGeneratorBase
    {
        public Template776(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
