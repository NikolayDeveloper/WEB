...
{
    [DocumentGenerator(5150, "PAT_DUPLIKAT")]
    public class IndustrialDesignPatentDuplicateTemplate: DocumentGeneratorBase
    {
        public IndustrialDesignPatentDuplicateTemplate(IExecutor executor,
