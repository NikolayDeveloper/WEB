...
{
    [DocumentGenerator(204, DicDocumentTypeCodes.DecisionConclusionGrantPatent)]
    public class Template4 : DocumentGeneratorBase
    {
        public Template4(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
