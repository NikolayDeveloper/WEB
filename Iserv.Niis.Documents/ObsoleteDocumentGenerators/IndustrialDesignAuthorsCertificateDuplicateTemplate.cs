...
{
    [DocumentGenerator(5164, "PAT_AVT_PO_D")]
    public class IndustrialDesignAuthorsCertificateDuplicateTemplate: DocumentGeneratorBase
    {
        public IndustrialDesignAuthorsCertificateDuplicateTemplate(IExecutor executor,
