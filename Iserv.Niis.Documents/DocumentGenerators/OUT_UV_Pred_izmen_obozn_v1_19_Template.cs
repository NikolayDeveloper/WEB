...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.UV_TZ_VN_IZM)]
    public class OUT_UV_Pred_izmen_obozn_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pred_izmen_obozn_v1_19_Template(IExecutor executor,
