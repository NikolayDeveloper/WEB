...
{
    [DocumentGenerator(514, DicDocumentTypeCodes.RequestForFullExamination)]
    public class Template73 : DocumentGeneratorBase
    {
        public Template73(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
