...
{
    [DocumentGenerator(5152, "SD_PAT_DUPLIKAT")]
    public class AgriculturalSelectiveAchievementsPatentDuplicateTemplate: DocumentGeneratorBase
    {
        public AgriculturalSelectiveAchievementsPatentDuplicateTemplate(IExecutor executor,
