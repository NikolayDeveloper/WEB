...
namespace Iserv.Niis.Features.Materials.Internal
{
    public class Single
    {
        public class Query : IRequest<MaterialInternalDetailDto>
        {
        ...
        public class QueryHandler : IAsyncRequestHandler<Query, MaterialInternalDetailDto>
        {
            ...
            async Task<MaterialInternalDetailDto> IAsyncRequestHandler<Query, MaterialInternalDetailDto>.Handle(
                Query message)
            {
