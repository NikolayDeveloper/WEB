...
namespace Iserv.Niis.Documents.DocumentGenerators
{
    ...
    public class OUT_Resh_pol_Otkaz_Reg_TZ_istech_srok_v1_19_Template: DocumentGeneratorBase
    {
        public OUT_Resh_pol_Otkaz_Reg_TZ_istech_srok_v1_19_Template(IExecutor executor,
