...
{
    [DocumentGenerator(5162, "PAT_AVT_IZ_D")]
    public class InventionAuthorsCertificateDuplicateTemplate: DocumentGeneratorBase
    {
        public InventionAuthorsCertificateDuplicateTemplate(IExecutor executor,
