    ...
    public class SendStageForDecision : INotificationMessageRequirement<Document>
    {
        ...
        public string Message
        {
            get
            {
                ...
                var currentWf = CurrentRequestObject.CurrentWorkflows.FirstOrDefault(d => d.CurrentUserId == currentUserId);
        ...
        public bool IsPassesRequirements()
        {
            var docTypes = new[]
            {
                ...
                //DicDocumentTypeCodes.OUT_Zakl_Pol_Predv_otkaz_Chast_Reg_TZ_V1_19,
                DicDocumentTypeCodes.ExpertTmRegisterRefusalOpinion,
                //DicDocumentTypeCodes.OUT_Zakl_Pol_Predv_otkaz_Reg_TZ_V1_19,
