...
{
    [TemplateFieldName(TemplateFieldName.PatentNameRu)]
    internal class PatentNameRu : TemplateFieldValueBase
    {
        public PatentNameRu(IExecutor executor) : base(executor)
        {
        }
