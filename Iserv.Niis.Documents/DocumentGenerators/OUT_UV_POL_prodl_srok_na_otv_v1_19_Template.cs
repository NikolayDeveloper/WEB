...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.MTZ_NEW_7)]
    public class OUT_UV_POL_prodl_srok_na_otv_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_POL_prodl_srok_na_otv_v1_19_Template(IExecutor executor,
