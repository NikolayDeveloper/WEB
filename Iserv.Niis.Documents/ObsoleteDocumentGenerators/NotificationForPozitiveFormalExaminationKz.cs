...
{
    [DocumentGenerator(3251, DicDocumentTypeCodes.NotificationForPozitiveFormalExaminationKz)]
    public class NotificationForPozitiveFormalExaminationKz : DocumentGeneratorBase
    {
        public NotificationForPozitiveFormalExaminationKz(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory, IFileConverter fileConverter, IDocxTemplateHelper docxTemplateHelper) 
