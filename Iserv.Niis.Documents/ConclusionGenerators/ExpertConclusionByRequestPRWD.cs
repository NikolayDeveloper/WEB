...
{
    [DocumentGenerator(4224, DicDocumentTypeCodes.TZPOL555PRWD)]
    public class ExpertConclusionByRequestPRWD : DocumentGeneratorBase, IComplexDataDocumentGenerator
    {
        private readonly IFileStorage _fileStorage;

        public ExpertConclusionByRequestPRWD(
            IExecutor executor,
        ...
        {
            return _expertConclusionByRequestHelper.FillData(Executor, _fileStorage, Parameters, DicDocumentTypeCodes.TZPOL555PRWD);
        }
