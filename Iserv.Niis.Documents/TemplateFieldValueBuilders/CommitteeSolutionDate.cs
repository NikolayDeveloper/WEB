...
{
	[TemplateFieldName(TemplateFieldName.CommitteeSolutionDate)]
	internal class CommitteeSolutionDate : TemplateFieldValueBase
	{
		public CommitteeSolutionDate(IExecutor executor) : base(executor)
		{
		}
		    ...
		    switch (ownerType)
		    {
		        case Owner.Type.Request:
		            ...
		            return requestProtectionDoc?.Type?.Code == DicProtectionDocTypeCodes.RequestTypeTrademarkCode
		                ? requestProtectionDoc.RegDate?.ToTemplateDateFormat() ?? string.Empty
		                : string.Empty;
                case Owner.Type.ProtectionDoc:
		            ...
		            return protectionDoc?.Type?.Code == DicProtectionDocTypeCodes.RequestTypeTrademarkCode
                        ? protectionDoc.RegDate?.ToTemplateDateFormat() ?? string.Empty
		                : string.Empty;
                default:
		            return string.Empty;
		    }
