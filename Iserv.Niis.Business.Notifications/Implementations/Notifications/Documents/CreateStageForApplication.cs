...
{
    public class CreateStageForApplication : INotificationMessageRequirement<Document>
    {
        ...
        public string Message
        {
            get
            {
                return string.Format(MessageTemplates.CreateStageForApplication, _requestDocument?.Request?.RequestNum ?? string.Empty);
            }
        }
