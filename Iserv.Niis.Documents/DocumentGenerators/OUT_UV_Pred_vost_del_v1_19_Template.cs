...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.ResponseDelapFormsExp)]
    public class OUT_UV_Pred_vost_del_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pred_vost_del_v1_19_Template(IExecutor executor,
