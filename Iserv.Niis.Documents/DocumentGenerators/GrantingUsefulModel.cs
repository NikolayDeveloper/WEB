...
{
    /// <summary>
    /// Решение и заключение о выдаче патента на полезную модель.
    /// </summary>
    [DocumentGenerator(0, DicDocumentTypeCodes.GrantingUsefulModel)]
    public class GrantingUsefulModel : DocumentGeneratorBase
    {
        public GrantingUsefulModel(
            IExecutor executor,
