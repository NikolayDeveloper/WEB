...
{
    public class IsProtectionDocumentValidityExpiredRule: BaseRule<ProtectionDocumentWorkFlowRequest>
    {
        public bool Eval()
        {
            ...
            return NiisAmbientContext.Current.DateTimeProvider.Now > protectonDoc.ValidDate;
        }
    }
}
