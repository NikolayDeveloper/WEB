...
@Injectable()
export class IndustrialdesignSearchService extends BaseServiceWithPagination<IndustrialdesignDto> {
  private api = '/api/search/expert/industrialdesign/';

  constructor(http: HttpClient,
    configService: ConfigService,
    errorHandlerService: ErrorHandlerService,
    private snackBarHelper: SnackBarHelper) {
    super(http, configService, errorHandlerService, '/api/search/expert/industrialdesign/');
  }

  public get(): Observable<IndustrialdesignDto[]> {
    return this.http.get(`${this.configService.apiUrl}${this.api}`)
      ...
      .map((data: IndustrialdesignDto[]) => data);
  }
