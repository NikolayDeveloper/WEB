...
{
    [DocumentGenerator(5151, "SD_PAT_2")]
    public class AnimalHusbandrySelectiveAchievementsPatentTemplate: DocumentGeneratorBase
    {
        public AnimalHusbandrySelectiveAchievementsPatentTemplate(IExecutor executor,
