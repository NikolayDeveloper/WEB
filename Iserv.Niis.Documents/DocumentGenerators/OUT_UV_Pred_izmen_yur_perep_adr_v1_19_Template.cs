...
namespace Iserv.Niis.Documents.DocumentGenerators
{
    ...
    public class OUT_UV_Pred_izmen_yur_perep_adr_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pred_izmen_yur_perep_adr_v1_19_Template(IExecutor executor,
