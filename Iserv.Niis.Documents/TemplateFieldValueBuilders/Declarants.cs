...
namespace Iserv.Niis.Documents.TemplateFieldValueBuilders
{
    ...
    /// Заявители.
    /// </summary>
    [TemplateFieldName(TemplateFieldName.Declarants)]
    internal class Declarants : TemplateFieldValueBase
    {
        public Declarants(IExecutor executor) : base(executor)
        {
        }
            ...
            switch (ownerType)
            {
                case Owner.Type.Request:
                    ...
                    customerNames = request
                        ...
                        .Select(customer => $"{customer.Customer.NameRu} ({customer.Customer.Country?.Code})");
                    break;
