...
namespace Iserv.Niis.Documents.TemplateFieldValueBuilders
{
	...
	[TemplateFieldName(TemplateFieldName.DateEarlyTermination)]
	internal class DateEarlyTermination : TemplateFieldValueBase
	{
		public DateEarlyTermination(IExecutor executor) : base(executor)
		{
		}
		    ...
		    switch (ownerType)
		    {
		        case Owner.Type.Request:
		            ...
		            var requestProtectionDoc = Executor.GetQuery<GetProtectionDocByRequestIdQuery>()
		                ...
		                .FirstOrDefault();
		            return requestProtectionDoc?.EarlyTerminationDate?.ToTemplateDateFormat() ?? string.Empty;
		        case Owner.Type.ProtectionDoc:
		            var protectionDoc = Executor.GetQuery<GetProtectionDocByIdQuery>()
		                .Process(q => q.Execute((int)parameters["RequestId"]));
		            return protectionDoc?.EarlyTerminationDate?.ToTemplateDateFormat() ?? string.Empty;
		        default:
		            return string.Empty;
		    }
		}
