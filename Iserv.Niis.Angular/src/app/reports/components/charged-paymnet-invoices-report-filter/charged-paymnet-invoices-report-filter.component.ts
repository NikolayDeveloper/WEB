...
@Component({
  selector: 'app-charged-paymnet-invoices-report-filter',
  templateUrl: './charged-paymnet-invoices-report-filter.component.html',
  styleUrls: ['./charged-paymnet-invoices-report-filter.component.scss']
})
export class ChargedPaymentInvoicesReportFilterComponent implements OnInit, OnDestroy {
  formGroup: FormGroup;
