...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.UV_TZ_VN_IZM_YUR_ADR_PER)]
    public class OUT_UV_Pol_izmen_yur_perep_adr_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pol_izmen_yur_perep_adr_v1_19_Template(IExecutor executor,
