...
{
    [DocumentGenerator(4206, "PRIL_NMPT_IZM")]
    public class Template309 : DocumentGeneratorBase
    {
        public Template309(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
