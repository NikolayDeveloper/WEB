...
{
    [DocumentGenerator(143, "PRODLPMP")]
    public class Template487 : DocumentGeneratorBase
    {
        public Template487(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
