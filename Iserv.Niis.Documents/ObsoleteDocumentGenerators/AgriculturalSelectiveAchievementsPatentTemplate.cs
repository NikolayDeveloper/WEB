...
{
    [DocumentGenerator(5152, "SD_PAT")]
    public class AgriculturalSelectiveAchievementsPatentTemplate: DocumentGeneratorBase
    {
        public AgriculturalSelectiveAchievementsPatentTemplate(IExecutor executor,
