...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.TZ_USTUP_PRAVA_ZN)]
    public class OUT_UV_Pol_ustup_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pol_ustup_v1_19_Template(IExecutor executor,
