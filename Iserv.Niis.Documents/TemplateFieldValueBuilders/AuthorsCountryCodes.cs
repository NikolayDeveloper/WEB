...
{
    [TemplateFieldName(TemplateFieldName.AuthorsCountryCodes)]
    internal class AuthorsCountryCodes : TemplateFieldValueBase
    {
        public AuthorsCountryCodes(IExecutor executor) : base(executor)
        {
        }
