...
{
    [TemplateFieldName(TemplateFieldName.CustomerAddress)]
    internal class CustomerAddress : TemplateFieldValueBase
    {
        public CustomerAddress(IExecutor executor) : base(executor)
        {
        }
