...
{
    [DocumentGenerator(891, "RKS_AVANS")]
    public class Template35 : DocumentGeneratorBase
    {
        public Template35(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
