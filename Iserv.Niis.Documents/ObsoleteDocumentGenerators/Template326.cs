...
{
    [DocumentGenerator(2352, "PRIL_IZ_PRED_POT")]
    public class Template326 : DocumentGeneratorBase
    {
        public Template326(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
