...
{
    [DocumentGenerator(0, DicDocumentTypeCodes.TZ_ZAP_O_DOV)]
    public class OUT_Zap_Pred_dover_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_Zap_Pred_dover_v1_19_Template(IExecutor executor,
