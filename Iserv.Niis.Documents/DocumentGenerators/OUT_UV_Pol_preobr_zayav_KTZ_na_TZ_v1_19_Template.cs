...
namespace Iserv.Niis.Documents.DocumentGenerators
{
    ...
    public class OUT_UV_Pol_preobr_zayav_KTZ_na_TZ_v1_19_Template : DocumentGeneratorBase
    {
        public OUT_UV_Pol_preobr_zayav_KTZ_na_TZ_v1_19_Template(IExecutor executor,
