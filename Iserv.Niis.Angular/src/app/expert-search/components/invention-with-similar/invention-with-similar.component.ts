...
@Component({
  selector: 'app-invention-with-similar',
  templateUrl: './invention-with-similar.component.html',
  styleUrls: ['./invention-with-similar.component.scss']
})
export class InventionWithSimilarComponent implements OnInit, OnDestroy {
