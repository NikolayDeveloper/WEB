...
namespace Iserv.Niis.Documents.DocumentGenerators
{
    ...
    public class OUT_Resh_pol_Chast_Reg_TZ_vozr_v1_19_Template: DocumentGeneratorBase
    {
        public OUT_Resh_pol_Chast_Reg_TZ_vozr_v1_19_Template(IExecutor executor,
