...
namespace Iserv.Niis.Documents.TemplateFieldValueBuilders
{
    ...
    /// </summary>
    [TemplateFieldName(TemplateFieldName.PaymentUseDate)]
    public class PaymentUseDate : TemplateFieldValueBase
    {
        public PaymentUseDate(IExecutor executor) : base(executor)
        {
        }
