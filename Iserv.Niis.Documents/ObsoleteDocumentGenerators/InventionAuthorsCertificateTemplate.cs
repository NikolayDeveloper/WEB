...
{
    [DocumentGenerator(5162, "PAT_AVT_IZ")]
    public class InventionAuthorsCertificateTemplate: DocumentGeneratorBase
    {
        public InventionAuthorsCertificateTemplate(IExecutor executor,
