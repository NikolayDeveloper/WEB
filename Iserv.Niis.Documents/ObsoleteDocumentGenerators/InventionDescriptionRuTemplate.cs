...
{
    [DocumentGenerator(6162, "OP_PAT")]
    public class InventionDescriptionRuTemplate : DocumentGeneratorBase
    {
        public InventionDescriptionRuTemplate(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
