...
{
    public class RfProtectionDocList
    {
        public class Query : IRequest<GetRfPatentListResult>
        {
            public readonly LogAction LogAction = new LogAction {Type = "GetRfPatentList"};
            public GetRfPatentListArgument Argument { get; set; }
            public GetRfPatentListResult Result { get; set; }
        }
        ...
        public class QueryHandler : IRequestHandler<Query, GetRfPatentListResult>
        {
            private readonly IRfProtectionDocService _rfProtectionDocService;

            public QueryHandler(IRfProtectionDocService rfProtectionDocService)
            {
                _rfProtectionDocService = rfProtectionDocService;
            }

            public GetRfPatentListResult Handle(Query message)
            {
                _rfProtectionDocService.GetRfProtectionDocs(message.Argument, message.Result);
        ...
        public class QueryException : AbstractionExceptionHandler<Query, GetRfPatentListResult>
        {
            private readonly SystemInfoHelper _systemInfoHelper;
            ...
            public override GetRfPatentListResult GetExceptionResult(Query message, Exception ex)
            {
