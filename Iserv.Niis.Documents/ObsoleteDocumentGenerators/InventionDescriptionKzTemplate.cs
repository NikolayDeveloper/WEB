...
{
    [DocumentGenerator(6162, "OP_PAT_KZ")]
    public class InventionDescriptionKzTemplate: DocumentGeneratorBase
    {
        public InventionDescriptionKzTemplate(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
