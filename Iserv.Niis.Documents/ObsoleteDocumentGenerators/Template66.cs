...
{
    [DocumentGenerator(4217, DicDocumentTypeCodes.NotificationOfRegistrationExaminationTimeExpiration)]
    public class Template66 : DocumentGeneratorBase
    {
        public Template66(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
        ...
        protected override Content PrepareValue()
        {
            return new Content(
                ...
                //BuildField(TemplateFieldName.ResponceDeadline),  // TODO Z.Alexandr добавить когда появится
                BuildField(TemplateFieldName.PaymentTermDate),
