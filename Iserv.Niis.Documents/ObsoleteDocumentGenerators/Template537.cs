...
{
    [DocumentGenerator(4170, "POL_1")]
    public class Template537 : DocumentGeneratorBase
    {
        public Template537(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
