...
namespace Iserv.Niis.Documents.UserInput.Helpers
{
    internal static class AsposeLicenseHelper
    {
        public static Stream Stream => new MemoryStream(Convert.FromBase64String(AsposeLicenseKey));

        private const string AsposeLicenseKey =
