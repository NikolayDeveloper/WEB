...
{
    [DocumentGenerator(10025, "SA_SOPR_2")]
    public class Template775 : DocumentGeneratorBase
    {
        public Template775(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
