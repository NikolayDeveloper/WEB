...
{
    [TemplateFieldName(TemplateFieldName.PatentAuthorsEn)]
    public class PatentAuthorsEn : TemplateFieldValueBase
    {
        public PatentAuthorsEn(IExecutor executor) : base(executor)
        {
        }
            ...
            switch (ownerType)
            {
                case Owner.Type.Request:
                    ...
                    authors = request.RequestCustomers
                        ...
                        .Select(customer => customer.Customer?.NameEn ?? string.Empty)
                        .ToArray();
