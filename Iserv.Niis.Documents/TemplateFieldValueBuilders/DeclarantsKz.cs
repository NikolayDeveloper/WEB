...
{
    [TemplateFieldName(TemplateFieldName.DeclarantsKz)]
    internal class DeclarantsKz : TemplateFieldValueBase
    {
        public DeclarantsKz(IExecutor executor) : base(executor)
        {
        }
            ...
            switch (ownerType)
            {
                case Owner.Type.Request:
                    ...
                    customerNames = request
                        ...
                        .Select(customer => $"{customer.Customer.NameKz} ({customer.Customer.Country?.Code})");
                    break;
