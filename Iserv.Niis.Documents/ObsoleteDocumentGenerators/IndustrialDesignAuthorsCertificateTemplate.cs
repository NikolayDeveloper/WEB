...
{
    [DocumentGenerator(5164, "PAT_AVT_PO")]
    public class IndustrialDesignAuthorsCertificateTemplate: DocumentGeneratorBase
    {
        public IndustrialDesignAuthorsCertificateTemplate(IExecutor executor,
