...
{
    public class GetContractsByProtectionDocIdQuery: BaseQuery
    {
        public async Task<List<Contract>> ExecuteAsync(int protectionDocId)
        {
            ...
            var contracts = repo.AsQueryable()
                ...
                .Where(c => c.ProtectionDocs.Any(cr => cr.ProtectionDocId == protectionDocId));
