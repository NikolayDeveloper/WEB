...
{
    [DocumentGenerator(6162, "OP_PAT_SA")]
    public class SelectiveAchievementDescriptionRuTemplate: DocumentGeneratorBase
    {
        public SelectiveAchievementDescriptionRuTemplate(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
