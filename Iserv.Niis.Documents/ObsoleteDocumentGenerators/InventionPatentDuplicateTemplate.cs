...
{
    [DocumentGenerator(5148, "OD_PAT_IZ_RU_DUPLIKAT")]
    public class InventionPatentDuplicateTemplate: DocumentGeneratorBase
    {
        public InventionPatentDuplicateTemplate(IExecutor executor,
