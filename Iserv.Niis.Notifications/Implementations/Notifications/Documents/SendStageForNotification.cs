    ...
    public class SendStageForNotification : INotificationMessageRequirement<Document>
    {
        ...
        public bool IsPassesRequirements()
        {
            ...
            var docTypes = new[]
            {
                ...
                "TZ_VN_IZM_ADR","TZ_VN_IZM","TZ_USTUP_PRAVA_ZN",
                ...
                "PREKRPAT_SA","PREKRPAT","PREKR_PO","TZPRED7","TZPRED6",
                "TZPRED5","TZPRED3","TZPRED2","NMPT1","TZPRED1.0","TZPRED1",
                "TZPRED10","TZPRED9","TZPRED_5_1","TZPRED8","PP_IZ-IZMEN",
                "TZPOL999","TZPOL99","TZPOL9","TZPOL8","TZPOL78","TZPOL77","TZPOL7",
                "TZPOL61_1","TZPOL61","TZPOL5","TZPOL4","TZPOL32_UVED","GR_TZ_POL_UV",
                ...
                //DicDocumentTypeCodes.OUT_Uv_pol_prekr_del_prosb_zayav_v1_19,
                //DicDocumentTypeCodes.OUT_Uv_pred_prekr_del_net_opl_exp_v1_19,
                //DicDocumentTypeCodes.OUT_Uv_GR_prekr_del_net_opl_reg_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pol_vost_del_v1_19,
                DicDocumentTypeCodes.OUT_UV_Pol_Reg_TZ_AP_sov_v1_19,
                //DicDocumentTypeCodes.OUT_UV_GR_Reg_TZ_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_prodl_srok_na_otv_v1_19,
                //DicDocumentTypeCodes.OUT_UV_POL_priostanov_del_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_vyd_zayavTZ_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pol_vyd_zayavTZ_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_izmen_naim_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_izmen_perech_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_izmen_predstav_v1_19,
                DicDocumentTypeCodes.OUT_UV_Pred_izmen_yur_adr_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_izmen_yur_perep_adr_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_izmen_obozn_v1_19,
                //DicDocumentTypeCodes.OUT_UV_Pred_ustup_v1_19,
            };
