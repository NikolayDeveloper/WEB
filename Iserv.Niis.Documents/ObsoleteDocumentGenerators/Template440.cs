...
{
    [DocumentGenerator(148, "VOSTPMP")]
    public class Template440 : DocumentGeneratorBase
    {
        public Template440(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
