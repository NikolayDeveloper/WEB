...
{
    [DocumentGenerator(5163, "PAT_AVT_PM")]
    public class UsefulModelAuthorsCertificateTemplate: DocumentGeneratorBase
    {
        public UsefulModelAuthorsCertificateTemplate(IExecutor executor,
