...
{
    [TemplateFieldName(TemplateFieldName.NumberApxWork)]
    internal class NumberApxWork : TemplateFieldValueBase
    {
        public NumberApxWork(IExecutor executor) : base(executor)
        {
        }
