...
namespace Iserv.Niis.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20181219060407_BaseWorkflow_Add_PrevWF")]
    partial class BaseWorkflow_Add_PrevWF
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Dictionaries.DicMain.DicContractType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.ExpertSearchViewEntity", b =>
                {
                    ...
                    b.Property<string>("AddressForCorrespondence")
                        .HasColumnName("AddressForCorrespondence");
                    ...
                    b.Property<string>("Confidant")
                        .HasColumnName("Confidant");

                    b.Property<string>("Declarant")
                        .HasColumnName("Declarant");

                    b.Property<string>("Description")
                        .HasColumnName("Description");

                    b.Property<string>("DisclaimerKz")
                        .HasColumnName("DisclaimerKz");

                    b.Property<string>("DisclaimerRu")
                        .HasColumnName("DisclaimerRu");

                    b.Property<DateTimeOffset?>("EarlyTerminationDate")
                        .HasColumnName("EarlyTerminationDate");

                    b.Property<DateTimeOffset?>("ExtensionDateTz")
                        .HasColumnName("ExtensionDateTz");

                    b.Property<string>("Formula")
                        .HasColumnName("Formula");

                    b.Property<DateTimeOffset?>("GosDate")
                        .HasColumnName("GosDate");

                    b.Property<string>("GosNumber")
                        .HasColumnName("GosNumber");

                    b.Property<string>("Icfems")
                        .HasColumnName("Icfems");

                    b.Property<string>("Icgs")
                        .HasColumnName("Icgs");

                    b.Property<string>("Icis")
                        .HasColumnName("Icis");

                    b.Property<string>("Ipcs")
                        .HasColumnName("Ipcs");
                    ...
                    b.Property<string>("PatentAttorney")
                        .HasColumnName("PatentAttorney");

                    b.Property<string>("PatentOwner")
                        .HasColumnName("PatentOwner");

                    b.Property<byte[]>("PreviewImage")
                        .HasColumnName("PreviewImage");

                    b.Property<string>("PriorityData")
                        .HasColumnName("PriorityData");

                    b.Property<string>("PriorityRegCountryNames")
                        .HasColumnName("PriorityRegCountryNames");

                    b.Property<DateTime?>("PriorityRegDate");

                    b.Property<string>("PriorityRegNumbers")
                        .HasColumnName("PriorityRegNumbers");
                    ...
                    b.Property<string>("RequestTypeNameRu")
                        .HasColumnName("RequestTypeNameRu");
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Workflow.BaseWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("BaseWorkflow");

                    b.HasDiscriminator<string>("Discriminator").HasValue("BaseWorkflow");
                });
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Contract.ContractWorkflow", b =>
                {
                    b.HasBaseType("Iserv.Niis.Domain.Entities.Workflow.BaseWorkflow");
                    ...
                    b.HasDiscriminator().HasValue("ContractWorkflow");
                });
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Document.DocumentWorkflow", b =>
                {
                    ...
                    b.Property<int>("OwnerId")
                        .HasColumnName("DocumentWorkflow_OwnerId");

                    b.HasIndex("OwnerId");

                    b.ToTable("DocumentWorkflows");

                    b.HasDiscriminator().HasValue("DocumentWorkflow");
                });
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.ProtectionDoc.ProtectionDocWorkflow", b =>
                {
                    ...
                    b.Property<int>("OwnerId")
                        .HasColumnName("ProtectionDocWorkflow_OwnerId");
                    ...
                    b.HasDiscriminator().HasValue("ProtectionDocWorkflow");
                });
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Request.RequestWorkflow", b =>
                {
                    ...
                    b.Property<int>("OwnerId")
                        .HasColumnName("RequestWorkflow_OwnerId");

                    b.HasIndex("OwnerId");

                    b.ToTable("RequestWorkflows");

                    b.HasDiscriminator().HasValue("RequestWorkflow");
                });
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Contract.Contract", b =>
                {
                    ...
                    b.HasOne("Iserv.Niis.Domain.Entities.Dictionaries.DicProtectionDocSubType", "ContractType")
                        .WithMany()
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Document.Document", b =>
                {
                    ...
                    b.HasOne("Iserv.Niis.Domain.Entities.Document.DocumentWorkflow", "CurrentWorkflow")
                        .WithMany()
                        .HasForeignKey("CurrentWorkflowId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Iserv.Niis.Domain.Entities.Workflow.BaseWorkflow", b =>
                {
                    ...
                    b.HasOne("Iserv.Niis.Domain.Entities.Workflow.BaseWorkflow", "PreviousWorkflow")
                        .WithMany()
