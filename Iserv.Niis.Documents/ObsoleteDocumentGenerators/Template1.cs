...
namespace Iserv.Niis.Documents.ObsoleteDocumentGenerators
{
    ...
    [DocumentGenerator(4216, "TZ_PRODL_OBSH")]
    public class Template1 : DocumentGeneratorBase
    {
        public Template1(IExecutor executor, ITemplateFieldValueFactory templateFieldValueFactory,
