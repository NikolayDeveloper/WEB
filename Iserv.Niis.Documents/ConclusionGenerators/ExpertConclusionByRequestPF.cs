...
{
    [DocumentGenerator(4224, DicDocumentTypeCodes.TZPOL555PF)]
    public class ExpertConclusionByRequestPF : DocumentGeneratorBase, IComplexDataDocumentGenerator
    {
        private readonly IFileStorage _fileStorage;

        public ExpertConclusionByRequestPF(
            IExecutor executor,
        ...
        {
            return _expertConclusionByRequestHelper.FillData(Executor, _fileStorage, Parameters, DicDocumentTypeCodes.TZPOL555PF);
        }
